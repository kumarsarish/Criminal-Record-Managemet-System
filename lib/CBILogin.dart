...
class CBILogin extends StatefulWidget {
  @override
  _CBILoginState createState() => _CBILoginState();
}

class _CBILoginState extends State<CBILogin> {
  ...
  void _signIn() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        if (securityCode == '987654321') {
          // Security code is correct, navigate to the CBILoginPage
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CasesPage(),  // Assuming you have a CBIPage for successful login
            ),
          );
        } else {
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/Detective.jpg'),
            fit: BoxFit.fill,
          ),
        ),
        child: Center(
